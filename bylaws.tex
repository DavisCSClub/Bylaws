...
\author{}
\date{Version 1.3\\Approved by Officer Board on May 9, 2017.}
...
\noindent The Club Advisor shall be any faculty from the Computer Science Department in the University of California, Davis, and shall be responsible for the following:
	\begin{li}
...
\end{li}
 ...
 The objective of the Pragmatic Programming Committee is to provide members with a practical application of computer science in comparison to the theoretical application taught by courses in the university. The Pragmatic Programming Committee must:
 \begin{li}
 \item Hold workshops to pertaining to computer science related topics.
 \end{li}

...
\author{}
\date{Version 1.2\\Approved by Officer Board on September 20, 2016.}
...
\item President\\
	...
	\item Chair and facilitate all Davis CS Club General Meetings and Core Body meetings.
...
Officers can create new committees for specific, short-term purposes, with the
following stipulations:
\begin{li}
\item All ad hoc committees must be led by an officer.
\item Ad hoc committees are not considered to have Chairs or Vice Chairs.
\item Students who are not officers can take part in ad hoc committees.
  When they do this, they do not gain the privileges of officers, and are not
  bound by club bylaws.
\item The President has the power to dissolve ad hoc committees.
\end{li}
...
\item The amendment shall appear as a business item on the Core Officer Meeting agenda no less than one (1) day from submission. A discussion must take place before any adoption, amendments, or rejection of amendments.
\item All amendments shall require an approval by a two-thirds (2/3) vote of the Core Body.
\item Amendments must be published at least one day before the general meeting in which it will be ratified.
